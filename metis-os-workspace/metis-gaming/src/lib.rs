...
pub use detect::{
    SteamInstall, detect_steam, flatpak_has_app, gamemode_installed, i386_vulkan_likely_missing,
    mesa_vulkan_amd64_missing, nvidia_gpu_present, nvidia_reboot_required,
};
