...
pub const CATEGORIES: &[Category] = &[
    ...
    Category {
        ...
        hue: NavHue::Green,
        blurb: "Users, date & time, updates, sound, power, locale, remote access, reset, about, and more",
    },
];
...
pub const NAV: &[NavItem] = &[
    ...
    NavItem {
        page_id: Some("updates"),
        title: "Updates",
        icon: Some("software-update-available-symbolic"),
        hue: Some(NavHue::Green),
        subtitle: Some("PackageKit, Flatpak, and firmware update checks"),
        category: Some("system"),
    },
    NavItem {
        page_id: Some("reset"),
